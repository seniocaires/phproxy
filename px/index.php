<?php
	...
	if(!isset($_SESSION['usuario']) || $_SESSION['usuario'] == null || $_SESSION['usuario'] == "") {
		echo "Sem autoriza&ccedil;&atilde;o";
...
$_labels            = array
                    (
                        'include_form'    => array('Incluir Form', 'Incluir mini URL-FORM em todas as p&aacute;ginas'), 
                        'remove_scripts'  => array('Remover Scripts', 'Remover scripts do lado do cliente (ex: JavaScript)'), 
                        'accept_cookies'  => array('Aceitar Cookies', 'Permitir que os cookies sejam armazenados'), 
                        'show_images'     => array('Mostrar Imagens', 'Mostrar imagens em p&aacute;ginas navegadas'), 
                        'show_referer'    => array('Mostrar Refer&ecirc;ncias', 'Mostrar a refer&ecirc;ncia do em cabe&ccedil;alhos HTTP.'), 
                        'rotate13'        => array('Rotate13', 'Usar codifica&ccedil;&atilde;o ROT13 no endere&ccedil;o'), 
                        'base64_encode'   => array('Base64', 'Usar codifica&ccedil;&atilde;o base64 no endere&ccedil;o'), 
                        'strip_meta'      => array('Remover Meta', 'Remover tags de meta informa&ccedil;&atilde;o das p&aacute;ginas'), 
                        'strip_title'     => array('Remover Title', 'Remover t&iacute;tulo da p&aacute;gina'), 
                        'session_cookies' => array('Sess&atilde;o - Cookies', 'Armazenar cookies somente para esta sess&atilde;o') 
                    );
...
{   
    wrl($_POST[$_config['url_var_name']]);
...
else
{
    ...
    if ($_flags['include_form'] && !isset($_GET['nf']))
    {
        $_url_form      = '<div style="width:100%;margin:0;text-align:center;border-bottom:1px solid #725554;color:#000000;background-color:#F2FDF3;font-size:12px;font-weight:bold;font-family:Bitstream Vera Sans,arial,sans-serif;padding:4px;">'
                        ...
                        . ' [navegar: <a href="' . $_script_url . '?' . $_config['url_var_name'] . '=' . encode_url($_url_parts['prev_dir']) .' ">subir diret&oacute;rio</a>, <a href="' . $_script_base . '">p&aacute;gina inicial</a>, <a href="logout.php">Logout</a>]'
                        . '<br /><hr />';
